 ...
 */
export const runMigrations = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<RunMigrationsData, ThrowOnError>) => {
    return (options?.client ?? client).post<RunMigrationsResponse, RunMigrationsError, ThrowOnError>({
        ...options,
